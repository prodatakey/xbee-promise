...
module.exports = function xbeePromiseLibrary(options) {
  ...
  function _createCallback(resolve, frameId, frameType) {
    return function resolverCallback(receivedFrame) {
  ...
  function _sendFramePromiseResponse(frame, timeoutMs, responseFrameType) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      callback = _createCallback(resolve, frameId, responseFrameType);
  ...
  function _localCommand(command, timeoutMs, commandParameter) {
    ...
    debug('Doing local command', command, 'with parameter', commandParameter || []);
  ...
  function _extractDestination64(commandData) {
    ...
    debug('Extracted 64 bit address:', address64);
  ...
  function _lookupByNodeIdentifier(nodeIdentifier, timeoutMs) {
    ...
    debug('Looking up', nodeIdentifier);
  ...
  function _remoteCommand(command, destination64, destination16, timeoutMs, commandParameter) {
      ...
      debug('Sending', command, 'to', destination64, 'with parameter', commandParameter || []);
  ...
  function _remoteTransmit(destination64, destination16, data, timeoutMs) {
    ...
    debug('Sending \'' + data + '\' to', destination64 || destination16);
  ...
  debug('Connecting to serialport', options.serialport);
